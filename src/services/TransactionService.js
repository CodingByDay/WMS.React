...
const TransactionService = {
  ...
  async getAllTransactions() {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=list&table=mh&i=web`,
    );
  ...
  async getPositionsByHeadId(headId) {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=list&table=mi&pars=${headId}&i=web`,
    );
    return response.data;
  },
  ...
  async getClients() {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=list&table=su&i=web`,
    );
    return response.data;
  },
  ...
  async getErpKeys() {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=list&table=erp&i=web`,
    );
    return response.data;
  },
  async getWarehouses() {
  ...
  async deleteHeadDocument(id) {
    ...
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=delMoveHead&head=${id}&i=web`,
    );
    return response;
  },
  ...
  async getOrdersForIdent(ident, type) {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=list&table=oo&pars=${ident}|${type}|0&i=web`,
    );
    return response.data;
  },
  ...
  async getUsers() {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=list&table=usr&i=web`,
    );
    return response.data;
  },
  ...
  async deleteMoveItem(id) {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=delMoveItem&item=${id}&i=web`,
    );
    return response;
  },
  async getNextSSCC() {
    const response = await axios.get(
      process.env.REACT_APP_API_URL +
        `/Services/Device/?mode=getObj&table=ns&id=&i=web`,
    );
    return response.data;
  },
};
