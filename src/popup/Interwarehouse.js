  ...
  return (
    <div className="layout-interwarehouse-container">
      <div className="layout-interwarehouse-checkbox">
        <label htmlFor="byOrder" id="hiddenLabel">
          Po naročilo
        </label>
      ...
      <div className="layout-interwarehouse-goods">
        <div className="left-column">
          ...
          <div className="warehouses-container">
            <Select
              className="select-filters interwarehouse"
              isDisabled={true}
              value={selectedIssuer}
              options={issueWarehouse}
              placeholder={"Izdajno skladišče"}
              id="issuingWarehouse"
            />
            <Select
              className="select-filters interwarehouse"
              ...
              options={receiveWarehouse}
              placeholder={"Prejemno skladišče"}
