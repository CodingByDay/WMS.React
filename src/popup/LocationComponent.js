...
export default function LocationComponent(props) {
  ...
  useEffect(() => {
    document.getElementById("identLocationComponent").value =
      props.data.ident.value;
    document.getElementById("nameLocationComponent").value = props.data.name;
    document.getElementById("neededQtyLocationComponent").value =
      props.data.real;
    document.getElementById("differenceLocationComponent").value =
      parseInt(document.getElementById("neededQtyLocationComponent").value) -
      parseInt(document.getElementById("qtyLocationComponent").value);

    var data = TransactionService.getLocations(props.data.warehouse).then(
      (response) => {
        var locations = [];
  ...
  function addLocation(e) {
    ...
    if (qtyCount > neededQty) {
      Swal.fire(
        "Napaka!",
        `Količina ne sme presegati ${neededQty}!!!`,
        "error",
      );
  ...
  function commitPositions(e) {
    ...
    for (var i = 0; i < tableData.length; i++) {
      ...
      PopupService.commitPosition({
        LinkKey: parseInt(key),
        LinkNo: no,
        Ident: props.data.ident.value,
        HeadID: transactionHeadID,
        Location: location,
        Qty: qty,
      }).then((response) => {});
    }
    ...
    <div id="locationComponent" className="locationComponent">
      ...
      <div className="outer_container">
          ...
          <div className="left-part">
            ...
            <div className="insistRow">
              ...
              <input
                type="text"
                className="form-control"
                id="nameLocationComponent"
                placeholder="Naziv"
              />
            </div>
            <div className="insistRow">
              <label htmlFor="neededQtyLocationComponent">
                Potrebna količina
              </label>
              <input
                type="text"
                className="form-control"
                id="neededQtyLocationComponent"
            ...
            <div className="insistRow">
              ...
              <input
                type="text"
                className="form-control"
                id="differenceLocationComponent"
                placeholder="Razlika"
              />
            </div>
          </div>
        ...
        <div className="add-location-container">
          ...
          <span className="actions smallerr" onClick={addLocation} id="">
            Dodaj
            <MdAdd />
          </span>
        </div>
        ...
        <div className="right-part">
          <span onClick={commitPositions} className="actions smallerr" id="">
            Potrdi
            <MdEdit />
          </span>

          <span className="actions smallerr" id="">
            Briši
            <MdDeleteOutline />
          </span>
        </div>
      ...
      <Table
        className="location-component_table"
        table="location"
        data={tableData}
        type="locationComponent"
        class="table_responsive_location-component"
      />
    </div>
  );
}
