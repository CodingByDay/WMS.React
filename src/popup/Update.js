...
const Update = (props) => {
            ...
            if (type === "dropdown") {
              const options = currentData.map((item) => {
                ...
                return {
                  ...
                  widths,
                  header: false,
                  helper: item[current.dropdownHelperField],
                };
              });
          ...
          if (found.dropdownId === key) {
            ...
            if (typeof insertObject != "undefined") {
              ...
              setSelectedOptions((prevSelectedOptions) => ({
                ...
                [key]: {
                  header: false,
                  helper: "Ni vpisanega opisa",
                  id: props.data.ID,
                  label: `${key}`,
                  names: ["Naziv", "Opis"],
                  properties: ["DefaultWarehouse", "Ni vpisanega opisa"],
                },
              }));
            }
          }
  ...
  const options = [
    ...
    {
      label: "Column 2",
      options: [{ value: "Value 2", label: "Label 2" } /* ... */],
    },
  ...
  const sendData = () => {
    ...
    if (props.selectedTable.updateUserId != "") {
      var parameterUser = {
        Name: props.selectedTable.updateUserId,
        Type: "Int64",
        Value: userIdAsInt,
      };
    ...
    SettingsService.insertSQLQuery(updateQuery, params).then((result) => {
      props.refresh();
      ...
      if (data) {
        ...
        Swal.fire("Napaka!", "Zapis ni bil posodobljen.", "error");
                  ...
                  <div key={column.accessor} className="form-group insert">
                    ...
                    {column.type === "dropdown" ? (
                      ...
                      <input
                        ...
                        {...(column.type !== "checkbox"
                          ? { value: getValue(column.accessor) }
                          : { checked: getValue(column.accessor) })}
