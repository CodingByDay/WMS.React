...
export function ImportOrders(props) {
  ...
  var columns_head = [
    ...
    },
    {
      ...
      default: "",
      required: false,
      friendly: "Uporabnik ki je vpisal",
    },
    {
      Name: "adTimeIns",
      Database: "DateTime",
